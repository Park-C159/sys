<template>
  <div id="outdoorTemperatureComponent"></div>
</template>
  ...
  methods: {
    drawChart() {
      this.myChart = this.$echarts.init(
        document.getElementById("outdoorTemperatureComponent")
      );

      var minTemp = Math.min(...this.outdoorTemperatureData.data) - 0.1;
      var maxTemp = Math.max(...this.outdoorTemperatureData.data) + 0.1;
      ...
      let option = {
        ...
        xAxis: {
          type: "category",
          data: this.outdoorTemperatureData.time,
        //   splitNum: 4,
        ...
        series: [
          {
            data: this.outdoorTemperatureData.data,
            showSymbol: false,
            type: "line",
            smooth: true,
          },
