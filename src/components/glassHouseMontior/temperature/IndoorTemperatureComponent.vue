<template>
  <div id="indoorTemperatureComponent"></div>
</template>
  ...
  methods: {
    drawChart() {
      this.myChart = this.$echarts.init(
        document.getElementById("indoorTemperatureComponent")
      );

      var minTemp = Math.min(...this.indoorTemperatureData.data) - 0.1;
      var maxTemp = Math.max(...this.indoorTemperatureData.data) + 0.1;
      ...
      let option = {
        ...
        xAxis: {
          type: "category",
          data: this.indoorTemperatureData.time,
        //   splitNum: 4,
        ...
        series: [
          {
            data: this.indoorTemperatureData.data,
            showSymbol: false,
            type: "line",
            smooth: true,
          },
